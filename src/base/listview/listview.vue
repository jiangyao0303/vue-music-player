<template>
	<scroll class="listview" :data="data" :listenScroll="listenScroll" @scroll="scroll" :probeType="probeType" ref="listview">
		<ul>
	...
	export default {
		...
		methods: {
			...
			onShortcutTouchStart(e) {
				let anchorIndex = getData(e.target, 'index')  // 获取当前被点击元素的索引值(data-index)
			...
			onShortcutTouchMove(e) {
				...
				let delte = (this.touch.y2 - this.touch.y1) / ANCHOR_HEIGHT | 0  // |0 向下取整
